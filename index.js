...
*/
const BotName = '👾Harleyda Bumi H👾'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/Harleydabumii'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6282235205986'; // Nomor whatsapplu cok
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Hendra Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Harleydabumii`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Harleydabumii`)
})
